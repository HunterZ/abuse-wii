...
(select section
        ('game_section
         ...
         (setq gamma_msg "Select the darkest grey visible on your\nscreen then click the check mark")
         (setq telep_msg "Press C/L button to teleport")
         ;(setq gamma_msg "Select the darkest grey visible on your\nmonitor then click the check mark") WWW: Abuse-SDL
         ;(setq telep_msg "Press down to teleport") WWW: Abuse-SDL
         ...
         (defun get_train_msg (message_num)
           (select message_num
                   ...
                   (0 "Aim gun with wiimote, fire with B button, jump with Z/ZL")
                   ;(0 "Aim gun with mouse, fire with left mouse button") WWW: Abuse-SDL
                   ;(0 "Aim gun with mouse, fire with left mouse button") XXX: Mac Abuse
                   (1 "Collect ammo to increase firing speed")
                   (2 "Press the C/L button to activate objects. This is a switch")
                   ;(2 "Press the down key to activate objects. This is a switch.") WWW: Abuse-SDL
                   (3 "This console saves the state of the game, press C/L button")
                   ;(3 "This console saves the state of the game, press down") WWW: Abuse-SDL
                   (4 "Press C/L button to activate platform")
                   ;(4 "Press down to activate platform") WWW: Abuse-SDL
                   (5 "Hold down the A button to use special powers")
                   ;(5 "Hold down the right mouse button to use special powers") WWW: Abuse-SDL
                   (6 "Use the - and + buttons to select weapons")
                   ;(6 "Use the CTRL & INS keys to select weapons") WWW: Abuse-SDL
                   ...
                   (7 "Press the Z/ZL button to climb up ladders, C/L to climb down")
                   ;(7 "Press the up key to climb ladders") WWW: Abuse-SDL
                   (8 "Press the C/L button to start!")
                   ;(8 "Press the down key to start!") WWW: Abuse-SDL

                   (9 "Shoot hidden walls to destroy them")
                   (10 "Shoot switch ball to activate")
                   (11 "Press C/L button to teleport")
                   ;(11 "Press down to teleport") WWW: Abuse-SDL
                   ))
